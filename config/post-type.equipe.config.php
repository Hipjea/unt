...
function equipe_init() {
    $labels = [
        ...
        'edit_item' => 'Editer',
        'new_item' => 'Nouvel equipe',
        'all_items' => 'Equipes',
        'view_item' => 'Voir fiche equipe',
        'search_items' => 'Chercher',
        'not_found' => 'Pas d\'equipe trouvé',
        'not_found_in_trash' => 'Pas d\'equipe trouvé dans la corbeille',
        'parent_item_colon' => '',
        'menu_name' => 'Equipes'
    ];
